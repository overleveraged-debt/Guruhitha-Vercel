...
import { Search, MapPin, FileText, CheckCircle, Users } from 'lucide-react'
  ...
  const processSteps = [
    {
      icon: Search,
      title: 'Discovery',
      description: 'Understanding your requirements and budget to find the perfect property',
      step: '01'
    },
    {
      icon: MapPin,
      title: 'Site Visits',
      description: 'Guided property visits and detailed area analysis with our experts',
      step: '02'
    },
    {
      icon: FileText,
      title: 'Documentation',
      description: 'Complete legal verification and paperwork assistance',
      step: '03'
    },
    {
      icon: CheckCircle,
      title: 'Deal Closure',
      description: 'Negotiation support and seamless transaction completion',
      step: '04'
    },
    {
      icon: Users,
      title: 'Post-sale Support',
      description: 'Continued assistance with registration, possession, and after-sales service',
      step: '05'
    }
  ]
    ...
    <section className="py-20 bg-brand-beige">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Your Property Journey with Us
          </h3>
          <p className="text-lg text-brand-text max-w-3xl mx-auto">
            Our comprehensive 5-step process ensures a smooth and transparent property transaction
          </p>
        </div>
